...
class Window(QMainWindow):
	def __init__(self, *args, **kwargs):
		...
		pythongeeks = QAction("Erode Sengunthar", self)
		pythongeeks.setStatusTip("Go to Erode Sengunthar engineering college website")
		pythongeeks.triggered.connect(lambda: self.go_to_URL(QUrl("https://erode-sengunthar.ac.in/")))
...
app.setApplicationName('Suresh Web Browser')
